...
def parse_args():
    ...
    parser.add_argument('--OFET_features', nargs='+', default=['Mn(kg/mol)','PDI','HOMO(eV)','LUMO(eV)'],help='Experimental Features')
    ...
    parser.add_argument('--Junction_site',nargs='+',default=['Fr','Cs'],help='Symbol of Junction site')
    ...
    parser.add_argument('--OFET_targets',nargs='+',default=['u_h','u_e'],help='Prediction targets')
